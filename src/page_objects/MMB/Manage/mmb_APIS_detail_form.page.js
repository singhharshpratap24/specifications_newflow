...
class APISPaxDetails{
   ...
   async APISPaxDetailsForm(PassNo, Nationality, Gov){
...
console.log(pax_secondary_details.length);
    ...
    for (let i=0; i<=(pax_count.length-1) ; i++){
        ...
        let submit                                      = page.locator(`//fieldset[@id="passportForm${i}"]//button[@value='Submit details'][normalize-space()='Submit details']`);
